...
(baselines/stagingseqnet/pretrained_sedf.pt), so it has no dispersion. The training
code lives in baselines/stagingseqnet/train_transfer.py and reads two
...
TT = os.path.join(REPO, "baselines", "stagingseqnet")
sys.path.insert(0, TT)
sys.path.insert(0, os.path.join(REPO, "baselines", "stagingseqnet"))
sys.path.insert(0, os.path.join(REPO, "baselines", "stagingseqnet"))
...
OUT = os.path.join(REPO, "results", "revision", "runs", "final",
