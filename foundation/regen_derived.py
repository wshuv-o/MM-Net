...
notebook uses.
  ...
  KMP_DUPLICATE_LIB_OK=TRUE python foundation/regen_derived.py
"""
import json
import os
...
FINAL = os.path.join(REPO, "results", "revision", "runs", "final")
...
def main():
    ...
    ev = os.path.join(REPO, "MMNet_Submission", "all_codes",
